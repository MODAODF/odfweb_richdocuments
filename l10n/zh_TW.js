OC.L10N.register(
    ...
    "Saved" : "已儲存",
    "Saved with error: Collabora Online should expose the same protocol as the server installation. Please check the ssl.enable and ssl.termination settings of your Collabora Online server." : "儲存時發生錯誤：ODF文件WEB應用元件 應公開與伺服器安裝相同的協定。請檢查您的 Collabora Online 伺服器的 ssl.enable 與 ssl.termination 設定。",
    ...
    "Nextcloud Office" : "ODF文件WEB應用元件",
    "Office" : "Office",
    "Empty" : "空的",
    "Anonymous guest" : "匿名訪客",
    "%s (Guest)" : "%s（訪客）",
    "Edit office documents directly in your browser." : "直接在您的瀏覽器中編輯辦公室文件。",
    "This application can connect to a Collabora Online (or other) server (WOPI-like Client). Nextcloud is the WOPI Host. Please read the documentation to learn more about that.\n\nYou can also edit your documents off-line with the Collabora Office app from the **[Android](https://play.google.com/store/apps/details?id=com.collabora.libreoffice)** and **[iOS](https://apps.apple.com/us/app/collabora-office/id1440482071)** store." : "此應用程式可以連線到 ODF文件WEB應用元件（或其他的）伺服器（類 WOPI 的客戶端）。Nextcloud 是 WOPI 主機。請閱讀文件以取得更多資訊。\n\n您也可以從 **[Android](https://play.google.com/store/apps/details?id=com.collabora.libreoffice)** 與 **[iOS](https://apps.apple.com/us/app/collabora-office/id1440482071)** 的應用程式商店安裝並使用 Collabora Office 應用程式離線編輯您的文件。",
    "Nextcloud Office is a powerful Collabora Online based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "ODF文件WEB應用元件 是一款功能強大，以 ODF文件WEB應用元件 為基礎的線上辦公室套裝軟體，支援協作編輯，支援所有主要文件、試算表與簡報檔案格式，並可與所有現代的瀏覽器共同運作。",
    "Collabora Online is a powerful LibreOffice-based online office suite with collaborative editing, which supports all major documents, spreadsheet and presentation file formats and works together with all modern browsers." : "ODF文件WEB應用元件 是一套以 LibreOffice 為基礎的線上辦公室套裝軟體，可用來協作編輯，支援所有主要文件、試算表與簡報檔案格式，並可與所有現代的瀏覽器共同運作。",
    ...
    "Could not establish connection to the Collabora Online server. This might be due to a missing configuration of your web server. For more information, please visit: " : "無法建立到 ODF文件WEB應用元件 伺服器的連線。這可能是因為您網路伺服器的設定遺失的關係。要取得更多資訊，請造訪：",
    "Connecting Collabora Online Single Click with Nginx" : "使用 Nginx 連線到 ODF文件WEB應用元件 單擊",
    "Could not establish connection to the Collabora Online server." : "無法建立到 ODF文件WEB應用元件 伺服器的連線。",
    "Setting up a new server" : "設定新伺服器",
    "Collabora Online should use the same protocol as the server installation." : "ODF文件WEB應用元件 應使用與伺服器安裝相同的協定。",
    "Collabora Online server is reachable." : "可連線至 ODF文件WEB應用元件 伺服器。",
    "Please configure a Collabora Online server to start editing documents" : "請設定 ODF文件WEB應用元件 伺服器以開始編輯文件",
    "Use your own server" : "使用您自己的伺服器",
    "Nextcloud Office requires a separate server running Collabora Online to provide editing capabilities." : "ODF文件WEB應用元件 需要一台執行 ODF文件WEB應用元件 的獨立伺服器來提供編輯功能。",
    "Collabora Online requires a separate server acting as a WOPI-like Client to provide editing capabilities." : "ODF文件WEB應用元件 需要獨立的伺服器作為類 WOPI 的客戶端來提供編輯功能。",
    "URL (and Port) of Collabora Online-server" : "ODF文件WEB應用元件 伺服器的 URL（與連接埠）",
    ...
    "Documents opened with the demo server configured will be sent to a 3rd party server. Only use this for evaluating Collabora Online." : "在設定了展示用伺服器的情況下開啟文件會將其傳送給第三方的伺服器。僅將其用於評估 ODF文件WEB應用元件。",
    "Please make sure you understand that the following will happen if you set up the Collabora Online demo." : "請確保您了解如果您設定了 ODF文件WEB應用元件 展示用伺服器的情況下會發生什麼事。",
    ...
    "Templates inside of this directory will be added to the template selector of Nextcloud Office." : "此目錄內的範本將會被新增至 ODF文件WEB應用元件 的範本選擇器中。",
    "Zotero" : "Zotero",
    ...
    "Saved with error: Collabora Online should use the same protocol as the server installation." : "儲存時發生錯誤：ODF文件WEB應用元件 應該使用與伺服器安裝相同的協定。",
    "Nextcloud Office requires a seperate server running Collabora Online to provide editing capabilities." : "ODF文件WEB應用元件 需要一台執行 ODF文件WEB應用元件 的獨立伺服器來提供編輯功能。",
    "Collabora Online requires a seperate server acting as a WOPI-like Client to provide editing capabilities." : "ODF文件WEB應用元件 需要獨立的伺服器作為類 WOPI 的客戶端來提供編輯功能。",
    ...
    "Collabora Online" : "ODF文件WEB應用元件",
    "Saving…" : "儲存中...",
    "Document already exists" : "文件已存在",
    "Collabora Online is enabled for all users by default. When this setting is active, only members of the specified groups can use it." : "ODF文件WEB應用元件 預設對所有使用者啟用。當此設定啟用時，僅特定群組的使用者可以使用它。",
    "Templates inside of this directory will be added to the template selector of Collabora Online." : "此目錄中的範本將會新增到 ODF文件WEB應用元件 的範本選取器中。",
    "User Templates" : "個人範本",
    "Templaterepo" : "範本中心",
    "No Template" : "無範本",
    ...
    "config console" : "管理後台",
    "Enable if your Collabora Online server uses a self signed certificate" : "若您的ODF文件WEB應用元件伺服器使用自行發行的憑證，請啟用",
    "All users can edit documents with Collabora Online by default. When this setting is active, only the members of the specified groups can edit and the others can only view documents." : "預設情況下所有使用者都能使用ODF文件WEB應用元件編輯文件，當此設定啟用時，只有特定群組成員才能編輯文件，而其它使用者只能查看文件。",
    "File convert": "轉檔功能",
    ...
    "The [convet-to] is not working or unavailable, please contact the system administrator": "轉檔功能沒有反應或尚未啟用，請聯繫系統管理員。",
