OC.L10N.register(
    ...
    "Templates inside of this directory will be added to the template selector of Nextcloud Office." : "此目錄中的範本將會新增到 ODF文件WEB應用元件 的範本選取器中。",
    "Zotero" : "Zotero",
    ...
    "Allow local address": "啟用區域位址",
    "After enabling, Nextcloud server will allow connections from local address": "啟用後，ODFWEB 伺服器將會允許來自區域網路位址的連線",
