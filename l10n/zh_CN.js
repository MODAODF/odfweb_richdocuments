OC.L10N.register(
    ...
    "Extra fonts" : "额外字型",
    "Upload extra font file" : "上传额外的字型档案",
    "Upload a font file" : "上传字型档案",
    ...
    "Make sure to set this URL: {url} in the coolwsd.xml file of your Collabora Online server to ensure the added fonts get loaded automatically." : "请确定在您的 Collabora Online 伺服器的 coolwsd.xml 档案中设定此 URL：{url}，以确保其会自动载入新增的字型。",
    ...
    "Install it from the app store." : "从应用程式商店安装它。",
    "If the installation from the app store fails, you can still do that manually using this command:" : "若从应用程式商店安装失败，您仍然可以使用此指令手动安装：",
    "it uses an insecure protocol (http)" : "使用了不安全的协定 (http)",
    "it is unreachable from the Internet (possibly because of a firewall, or lack of port forwarding)" : "无法从网际网路存取（可能是因为防火墙，或是缺少连接埠转发）",
    ...
    "File convert": "转档功能",
    "The [convet-to] of the {productName} is available": "{productName}转档功能已启用",
    "Enable convert files": "开放转档",
    "After enabling, the file conversion options will display in action menu of file list": "开放转档后，档案列表中将显示转档相关的操作选项",
    "The [convet-to] of the {productName} is unavailable": "{productName}的转档功能未启用",
    "Save as PDF" : "转存为 PDF",
    "Finished file convert": "转档结束",
    "Save as ODF": "转存为 ODF",
    "No files to convert": "没有要转换的文件",
    "The following {num} files will be convert to ODF format:": "下列 {num} 个文件将转存为 ODF 格式文件：",
    "Failed to convert file": "转档失败",
    "Failed to convert files ({num})": "转档失败 ({num})",
    "A new folder will be created to store the converted files, please set a new folder name": "将建立新资料夹存放转档完成的文件，请设定新资料夹名称",
    "Invalid name": "无效的名称",
    "Could not create folder": "无法建立资料夹",
    "New folder name": "新资料夹名称",
    "The [convet-to] is not working or unavailable, please contact the system administrator": "转档功能没有反应或尚未启用，请联系系统管理员。",
